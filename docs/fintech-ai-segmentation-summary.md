...
|---|---|---|
| `high_value_active` | 2,000 (20%) | High balance, many transactions, very engaged |
| `mid_value_regular` | 3,000 (30%) | Medium balance, regular transactions, moderately engaged |
| `low_value_dormant` | 3,000 (30%) | Low balance, rare transactions, low engagement |
| `at_risk_churner` | 2,000 (20%) | Near-zero balance, almost inactive, high churn signal |
...
- `avg_monthly_revenue` — revenue NovaPay generates from this customer
...
```
Faker
  → generates 10,000 customers with 4 planted segments
        ↓
Pandas Pipeline
